...
import { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetchJson, sleep, reSize } from './lib/myfunc.js'; // removed 'await'

const { baileys, boom, chalk, fs: fsMod, figlet, FileType, path: pathMod, pino, process: proc, PhoneNumber, axios, yargs, _ } = modul;

const { Boom } = boom;

let _welcome = JSON.parse(fs.readFileSync('./database/welcome.json', 'utf-8'));
let _left = JSON.parse(fs.readFileSync('./database/left.json', 'utf-8'));
...
cfonts.say('DARE', {
    ...
    rawMode: false,
		...
		await sleep(30000)
Dare.sendMessage(`2347076945585@s.whatsapp.net`, { text: `*•𝐁𝐎𝐓 𝐈𝐒 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐄𝐃 ✅ *`})
...
require('./Case')(Dare, m, chatUpdate, store)
} catch (err) {
console.log(err)}})
